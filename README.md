# 🛡️ 학교폭력 초기 대응 가이드 - 안전지대 (Safety Zone)
...
## 🔗 서비스 접속하기
👉 **[서비스 바로가기 (Live Demo)](https://school-violence-response-guide-618656033778.us-west1.run.app/)**

---

## 📝 프로젝트 소개 (Overview)

**'안전지대'**는 학교폭력 발생 직후, 심리적 공황 상태(Panic)에 빠진 피해 학생과 보호자가 **가장 빠르고 정확하게 올바른 대응 절차**를 찾을 수 있도록 돕는 웹 애플리케이션입니다.
